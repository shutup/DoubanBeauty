 ...
 */
public class BeautyType5Fragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_beauty_type5, container, false);
